...
Relative, superlative, qualitative, frontier, and identity-bearing terms may encode
an outcome, success criterion, constraint, evidence-acquisition directive, public
claim, or several of these. Do not keep them as decorative wording or reduce the
underlying aspiration to claims clearance. For each consequential term compile a
comparison contract: exact subject and decision; beneficiary, job, setting, and
lifecycle; reference class and observation date; dimensions, trade-offs, minimum bar,
and superiority rule; admissible evidence and counterevidence; horizon/freshness;
owner, validation method, and change trigger. Keep aspiration, current fact, and
externally permitted claim as separate states. Ask only for a missing interpretation
that changes the work; otherwise retain testable alternatives as unresolved.

Before freezing topology and before delivery, run semantic conservation: every
accepted clause and consequential qualifier must map by stable ID to a decision,
criterion, owned acquisition path, explicit condition, or terminal disposition.
Textual mention, prohibition, or a broadly related artifact does not count. Any lost
or narrowed meaning reopens intent compilation and invalidates its descendants.
